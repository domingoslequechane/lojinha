...
export const KanbanColumnComponent: React.FC<KanbanColumnComponentProps> = ({
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
      className={`flex flex-col w-80 min-w-[320px] max-w-[320px] h-full max-h-full rounded-2xl bg-[#0F2D26] border transition-all duration-200 select-none overflow-hidden flex-shrink-0 ${
        isDragOver
