...
import { Clock, MessageSquare, Check, X, Calendar, Phone, Bell, Package, MapPin, ShoppingBag } from 'lucide-react';
      ...
      <div className="bg-[#0F2D26] border border-[#235447] rounded-3xl w-full max-w-xl max-h-[85vh] sm:max-h-[90vh] flex flex-col overflow-hidden shadow-2xl animate-in slide-in-from-bottom-4 sm:zoom-in-95 duration-200">
        ...
        <div className="p-4 bg-[#14382F] border-b border-[#235447] flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-sm text-[#FDFEF8]">Agendamentos Pendentes</h3>
        ...
        <div className="p-4 sm:p-5 overflow-y-auto space-y-3 flex-1">
          {leadsWithFollowUp.length === 0 ? (
            <div className="p-8 text-center text-[#95BDB0]">
              ...
              <p className="text-sm font-medium text-[#FDFEF8]">Nenhum agendamento pendente!</p>
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`inline-flex items-center gap-1 text-[10px] font-bold px-1.5 py-0.5 rounded-full ${
                            isEntrega ? 'bg-blue-500/20 text-blue-300' : 'bg-amber-500/20 text-amber-300'
                          }`}>
                            {isEntrega ? <Package className="w-2.5 h-2.5" /> : <Bell className="w-2.5 h-2.5" />}
                            {isEntrega ? 'Entrega' : 'Follow Up'}
                          </span>
                        </div>
