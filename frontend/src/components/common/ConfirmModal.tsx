...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/75 backdrop-blur-md flex items-end sm:items-center justify-center p-3 sm:p-4 z-50 animate-in fade-in duration-150">
      <div className="bg-[#0F2D26] border border-[#235447] rounded-3xl w-full max-w-sm max-h-[85vh] sm:max-h-[90vh] overflow-hidden shadow-2xl p-5 sm:p-6 text-center animate-in slide-in-from-bottom-4 sm:zoom-in-95 duration-150 space-y-4">
        {/* Icon Circle */}
