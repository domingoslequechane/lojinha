            ...
            <form onSubmit={handleVerify2FA} className="space-y-3.5">
              ...
              <div className="flex gap-2.5 pt-1">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl text-xs font-bold bg-[#C1F76B] text-[#0F2D26] hover:bg-[#C1F76B]/90 disabled:opacity-50 cursor-pointer shadow-md shadow-[#C1F76B]/20"
                >
                  Confirmar
                </button>
              </div>
